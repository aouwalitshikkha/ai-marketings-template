...
def seed_demo_data(apps, schema_editor):
    ...
    terms = [
        ('AI Marketing', 'The use of artificial intelligence technologies — such as machine learning, natural language processing, and generative AI — to automate, optimize, and personalize marketing activities.', 'Encompasses content creation, audience targeting, predictive analytics, and campaign management.'),
        ...
        ('Predictive Analytics', 'The use of data, statistical algorithms, and machine learning to identify the likelihood of future outcomes based on historical data.', 'Powers customer lifetime value prediction, churn risk scoring, and lead scoring.'),
